 ...
 * @package Addons_Kit
 */
namespace Addons_kit\Elementor\Widget;
...
class Testimonial_Slider extends Widget_Base{
	...
	public function get_name(){
		return 'ake-testimonial-slider';
	}

	public function get_title(){
		return esc_html__('Testimonial Slider', 'addons-kit-elementor');
	}
	...
	public function get_categories(){
		return ['addons-kit-elementor'];
	}

	public function get_keywords(){
		return [
			'testimonial slider',
			'ake testimonial slider',
			'ake testimonial carousel',
			'endorsement',
			'review',
			'feedback',
			'quote',
